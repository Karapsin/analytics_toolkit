...
from analytics_toolkit.sql.backends.ch.creation_policy import (
    prepare_cluster_routed_transfer_staging_policy,
...
def resolve_operation_ddl(
    config: Any,
    *,
    cluster_routed_transfer_staging: bool = False,
    **clickhouse_overrides: Any,
) -> OperationDdlDefaults:
    ...
    regular_policy = resolve_clickhouse_creation_policy(
        regular,
