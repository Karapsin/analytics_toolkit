...
from ..dml.transfer.runtime.models import TransferOptions
...
def estimate_source_rows(options: TransferOptions, connection: Any) -> int | None:
    ...
    try:
        ...
        get_backend_adapter(options.from_db_backend).rollback_quietly(connection)
        time_print(
...
def _estimate_gp_source_rows(
    ...
    *,
    ...
    try:
        ...
        get_backend_adapter("gp").rollback_quietly(connection)
