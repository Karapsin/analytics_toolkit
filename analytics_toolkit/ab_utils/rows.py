...
def _build_metric_row_from_prepared_context(
    ...
    return {
        "metric_name": metric_key,
        "n_group_1": int(test_stats["n"]),
        "n_group_2": int(baseline_stats["n"]),
        "outliers_cutoff": _get_outlier_cutoff(prepared_metric_context.get("outlier_context")),
        "outliers_n_group_1": outliers_n_test,
        "outliers_n_group_2": outliers_n_control,
        "metric_group_1": test_stats["ratio"],
        "metric_group_2": baseline_stats["ratio"],
