...
from tests.sql.integration._support.faults import FaultController
from tests.sql.integration._support.identity import safe_identifier
...
def assert_no_toolkit_leaks(  # noqa: C901, PLR0912, PLR0915
    ...
    if compose_project:
        minio_command = [
            ...
            compose_project,
            "--file",
            str(REPO_ROOT / "integration/docker-compose.yml"),
            "exec",
            "-T",
            "minio-client",
            "mc",
