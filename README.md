...
**Suggests:** [apache-airflow](https://pypi.org/project/apache-airflow/) (`>=2.4,<3`; optional extra `airflow`), [chromadb](https://pypi.org/project/chromadb/) (`>=0.5,<2; python_version >= '3.9'`; optional extra `rag`), [markdown-it-py](https://pypi.org/project/markdown-it-py/) (`>=3,<5`; optional extra `rag`), [ollama](https://pypi.org/project/ollama/) (`>=0.4,<1`; optional extra `rag`), [rank-bm25](https://pypi.org/project/rank-bm25/) (`>=0.2.2,<1`; optional extra `rag`), [sentence-transformers](https://pypi.org/project/sentence-transformers/) (`>=3,<6; python_version >= '3.9'`; optional extra `rag`), [openai](https://pypi.org/project/openai/) (`>=1,<3`; optional extra `rag-openai`), [anthropic](https://pypi.org/project/anthropic/) (`>=0.40,<2`; optional extra `rag-anthropic`), [google-genai](https://pypi.org/project/google-genai/) (`>=1,<2`; optional extra `rag-gemini`), [chromadb](https://pypi.org/project/chromadb/) (`>=0.5,<2; python_version >= '3.9'`; optional extra `rag-all`), [markdown-it-py](https://pypi.org/project/markdown-it-py/) (`>=3,<5`; optional extra `rag-all`), [ollama](https://pypi.org/project/ollama/) (`>=0.4,<1`; optional extra `rag-all`), [rank-bm25](https://pypi.org/project/rank-bm25/) (`>=0.2.2,<1`; optional extra `rag-all`), [sentence-transformers](https://pypi.org/project/sentence-transformers/) (`>=3,<6; python_version >= '3.9'`; optional extra `rag-all`), [openai](https://pypi.org/project/openai/) (`>=1,<3`; optional extra `rag-all`), [anthropic](https://pypi.org/project/anthropic/) (`>=0.40,<2`; optional extra `rag-all`), [google-genai](https://pypi.org/project/google-genai/) (`>=1,<2`; optional extra `rag-all`)<br>
...
[RAG docs assistant](https://github.com/Karapsin/analytics_toolkit/blob/main/docs/RAG_DOCS_ASSISTANT.md)

Install the optional local RAG dependencies, build a docs index, and ask
questions from the repository documentation:
...
For all local and hosted RAG providers, install `analytics-toolkit[rag-all]`.
