...
**Suggests:** [apache-airflow](https://pypi.org/project/apache-airflow/) (`>=2.4,<3`; optional extra `airflow`), [fsspec](https://pypi.org/project/fsspec/) (`>=2024.2`; optional extra `parquet-transfer`), [pyarrow](https://pypi.org/project/pyarrow/) (`>=14,<23`; optional extra `parquet-transfer`), [s3fs](https://pypi.org/project/s3fs/) (`>=2024.2`; optional extra `parquet-transfer`)<br>
