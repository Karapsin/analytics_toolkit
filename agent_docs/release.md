...
- The publish workflow must upload only the wheel and sdist emitted after the
  shared artifact smoke checker passes; do not rebuild between verification and
  publishing.
