...
you need exact signatures and input defaults.

## All SQL Formatting Functions

- [All SQL formatting functions](functions/index.md)

## Workflow Guides

- [Formatting and CTE rewrites](formatting-and-rewrites.md)
